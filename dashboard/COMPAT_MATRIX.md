# 🧭 COMPAT_MATRIX.md — Safe AI Dashboard v6 (auto-generated)

**Sugeneruota:** 2025-11-07 18:06:33
...
| `/api/risk_summary` | Rizikos santrauka | dd_day_pct<br>dd_week_pct<br>dd_month_pct<br>status |
| `/api/ai_summary` | AI veikimo santrauka | accuracy_pct<br>avg_pnl_pct<br>active_signals |
| `/api/ai_sizer` | AI dydžių/boost santrauka | min_trade_usdc<br>max_trade_usdc<br>boost_avg<br>vol_avg<br>max_positions<br>open_positions<br>portfolio_usage_pct |
...
| `/api/runtime` | Boto veikimo laikas | uptime<br>since |
